...
class Line:
    ...
    def line01(self):
        ...
        if self.station == '광명':
            url = "https://bus.go.kr/getSubway_6.jsp?statnId=1001075410&subwayId=1001&tabmn=5&tsub=3"

        elif self.station == '서동탄':
            self.station_no = self.station_no.replace('P', '')
            self.station_no = self.station_no.replace('-', '')
            url = "https://bus.go.kr/getSubway_6.jsp?statnId=100180" + self.station_no + "&subwayId=1001&tabmn=5&tsub=3"
            ...
            if sno > 173:
                ...
                if sno > 175:
                    sno -= 1
            url = "https://bus.go.kr/getSubway_6.jsp?statnId=1001080" + str(sno) + "&subwayId=1001&tabmn=5&tsub=3"

        elif '-' in self.station_no:
            self.station_no = self.station_no.replace('-', '')
            sno = int(self.station_no)
            print(sno)
            url = "https://bus.go.kr/getSubway_6.jsp?statnId=100100" + str(sno) + "&subwayId=1001&tabmn=5&tsub=3"
        else:
            url = "https://bus.go.kr/getSubway_6.jsp?statnId=1001000" + self.station_no + "&subwayId=1001&tabmn=5&tsub=3"
    ...
    def line05(self):
        ...
        if 'P' in self.station_no:
            ...
            url = "https://bus.go.kr/getSubway_6.jsp?statnId=1005080" + self.station_no + "&subwayId=1005&tabmn=5&tsub=3"

        elif '-' in self.station_no:
            station_no = self.station_no.replace('-', '')
            sno = int(station_no)
            print(sno)
            url = "https://bus.go.kr/getSubway_6.jsp?statnId=100500" + str(sno) + "&subwayId=1005&tabmn=5&tsub=3"
        else:
            url = "https://bus.go.kr/getSubway_6.jsp?statnId=1005000" + self.station_no + "&subwayId=1005&tabmn=&tsub=3"
    ...
    def lineN(self):
        if '-' in self.station_no:
            ...
            sno = int(station_no)
            print(sno)
            url = "https://bus.go.kr/getSubway_6.jsp?statnId=100200" + str(sno) + "&subwayId=1002&tabmn=5&tsub=3"
        else:
